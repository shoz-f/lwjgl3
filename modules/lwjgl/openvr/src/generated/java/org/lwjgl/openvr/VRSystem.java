...
public class VRSystem {
    ...
    // --- [ VRSystem_DriverDebugRequest ] ---

    /** Unsafe version of: {@link #VRSystem_DriverDebugRequest DriverDebugRequest} */
    ...
    public static int VRSystem_DriverDebugRequest(@NativeType("TrackedDeviceIndex_t") int unDeviceIndex, @NativeType("char const *") ByteBuffer pchRequest, @Nullable @NativeType("char *") ByteBuffer pchResponseBuffer) {
        ...
        return nVRSystem_DriverDebugRequest(unDeviceIndex, memAddress(pchRequest), memAddressSafe(pchResponseBuffer), remainingSafe(pchResponseBuffer));
    }
