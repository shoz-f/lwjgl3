...
public class CUDA_HOST_NODE_PARAMS extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CUDA_HOST_NODE_PARAMS} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    @NativeType("CUhostFn")
    public long fn() { return nfn(address()); }
    /** Returns the value of the {@code userData} field. */
    @NativeType("void *")
    public long userData() { return nuserData(address()); }

    /** Sets the specified value to the {@code fn} field. */
    public CUDA_HOST_NODE_PARAMS fn(@NativeType("CUhostFn") long value) { nfn(address(), value); return this; }
    ...
    /** Returns a new {@link CUDA_HOST_NODE_PARAMS} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CUDA_HOST_NODE_PARAMS malloc() {
        return wrap(CUDA_HOST_NODE_PARAMS.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CUDA_HOST_NODE_PARAMS} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CUDA_HOST_NODE_PARAMS calloc() {
        return wrap(CUDA_HOST_NODE_PARAMS.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CUDA_HOST_NODE_PARAMS} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link CUDA_HOST_NODE_PARAMS} instance for the specified memory address. */
    ...
    /** Returns a new {@link CUDA_HOST_NODE_PARAMS} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUDA_HOST_NODE_PARAMS mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CUDA_HOST_NODE_PARAMS} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CUDA_HOST_NODE_PARAMS callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CUDA_HOST_NODE_PARAMS} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CUDA_HOST_NODE_PARAMS} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static long nfn(long struct) { return memGetAddress(struct + CUDA_HOST_NODE_PARAMS.FN); }
    /** Unsafe version of {@link #userData}. */
    public static long nuserData(long struct) { return memGetAddress(struct + CUDA_HOST_NODE_PARAMS.USERDATA); }

    /** Unsafe version of {@link #fn(long) fn}. */
    public static void nfn(long struct, long value) { memPutAddress(struct + CUDA_HOST_NODE_PARAMS.FN, check(value)); }
    ...
    public static class Buffer extends StructBuffer<CUDA_HOST_NODE_PARAMS, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CUDA_HOST_NODE_PARAMS.Buffer} instance backed by the specified container.
         *
        ...
        /** Returns the value of the {@code fn} field. */
        @NativeType("CUhostFn")
        public long fn() { return CUDA_HOST_NODE_PARAMS.nfn(address()); }
        /** Returns the value of the {@code userData} field. */
        @NativeType("void *")
        public long userData() { return CUDA_HOST_NODE_PARAMS.nuserData(address()); }

        /** Sets the specified value to the {@code fn} field. */
        public CUDA_HOST_NODE_PARAMS.Buffer fn(@NativeType("CUhostFn") long value) { CUDA_HOST_NODE_PARAMS.nfn(address(), value); return this; }
        /** Sets the specified value to the {@code userData} field. */
