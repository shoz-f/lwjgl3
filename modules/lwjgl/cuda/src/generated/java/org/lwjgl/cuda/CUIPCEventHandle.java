...
public class CUIPCEventHandle extends Struct implements NativeResource {
    ...
    public CUIPCEventHandle reserved(@NativeType("char[64]") ByteBuffer value) { nreserved(address(), value); return this; }
    ...
    public static ByteBuffer nreserved(long struct) { return memByteBuffer(struct + CUIPCEventHandle.RESERVED, 64); }
    /** Unsafe version of {@link #reserved(int) reserved}. */
    public static byte nreserved(long struct, int index) {
        return UNSAFE.getByte(null, struct + CUIPCEventHandle.RESERVED + check(index, 64) * 1);
    }
    ...
    public static void nreserved(long struct, int index, byte value) {
        UNSAFE.putByte(null, struct + CUIPCEventHandle.RESERVED + check(index, 64) * 1, value);
    }
    ...
    public static class Buffer extends StructBuffer<CUIPCEventHandle, Buffer> implements NativeResource {
        ...
        /** Copies the specified {@link ByteBuffer} to the {@code reserved} field. */
        public CUIPCEventHandle.Buffer reserved(@NativeType("char[64]") ByteBuffer value) { CUIPCEventHandle.nreserved(address(), value); return this; }
        /** Sets the specified value at the specified index of the {@code reserved} field. */
