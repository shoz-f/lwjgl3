...
public class CUDA_KERNEL_NODE_PARAMS extends Struct implements NativeResource {
    ...
    /**
     * Creates a {@link CUDA_KERNEL_NODE_PARAMS} instance at the current position of the specified {@link ByteBuffer} container. Changes to the buffer's content will be
    ...
    public int func() { return nfunc(address()); }
    ...
    public CUDA_KERNEL_NODE_PARAMS func(@NativeType("CUfunction") int value) { nfunc(address(), value); return this; }
    ...
    /** Returns a new {@link CUDA_KERNEL_NODE_PARAMS} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed. */
    public static CUDA_KERNEL_NODE_PARAMS malloc() {
        return wrap(CUDA_KERNEL_NODE_PARAMS.class, nmemAllocChecked(SIZEOF));
    }

    /** Returns a new {@link CUDA_KERNEL_NODE_PARAMS} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed. */
    public static CUDA_KERNEL_NODE_PARAMS calloc() {
        return wrap(CUDA_KERNEL_NODE_PARAMS.class, nmemCallocChecked(1, SIZEOF));
    }

    /** Returns a new {@link CUDA_KERNEL_NODE_PARAMS} instance allocated with {@link BufferUtils}. */
    ...
    /** Returns a new {@link CUDA_KERNEL_NODE_PARAMS} instance for the specified memory address. */
    ...
    /** Returns a new {@link CUDA_KERNEL_NODE_PARAMS} instance allocated on the thread-local {@link MemoryStack}. */
    public static CUDA_KERNEL_NODE_PARAMS mallocStack() {
        return mallocStack(stackGet());
    }

    /** Returns a new {@link CUDA_KERNEL_NODE_PARAMS} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
    public static CUDA_KERNEL_NODE_PARAMS callocStack() {
        return callocStack(stackGet());
    }

    /**
     * Returns a new {@link CUDA_KERNEL_NODE_PARAMS} instance allocated on the specified {@link MemoryStack}.
     *
    ...
    /**
     * Returns a new {@link CUDA_KERNEL_NODE_PARAMS} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    ...
    public static int nfunc(long struct) { return UNSAFE.getInt(null, struct + CUDA_KERNEL_NODE_PARAMS.FUNC); }
    ...
    /** Unsafe version of {@link #func(int) func}. */
    public static void nfunc(long struct, int value) { UNSAFE.putInt(null, struct + CUDA_KERNEL_NODE_PARAMS.FUNC, value); }
    ...
    public static class Buffer extends StructBuffer<CUDA_KERNEL_NODE_PARAMS, Buffer> implements NativeResource {
        ...
        /**
         * Creates a new {@link CUDA_KERNEL_NODE_PARAMS.Buffer} instance backed by the specified container.
         *
        ...
        /** Returns the value of the {@code func} field. */
        @NativeType("CUfunction")
        public int func() { return CUDA_KERNEL_NODE_PARAMS.nfunc(address()); }
        /** Returns the value of the {@code gridDimX} field. */
        @NativeType("unsigned int")
        ...
        /** Sets the specified value to the {@code func} field. */
        public CUDA_KERNEL_NODE_PARAMS.Buffer func(@NativeType("CUfunction") int value) { CUDA_KERNEL_NODE_PARAMS.nfunc(address(), value); return this; }
        /** Sets the specified value to the {@code gridDimX} field. */
