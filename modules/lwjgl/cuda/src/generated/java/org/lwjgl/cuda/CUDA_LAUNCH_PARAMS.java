...
public class CUDA_LAUNCH_PARAMS extends Struct implements NativeResource {
    ...
    public int function() { return nfunction(address()); }
    ...
    public CUDA_LAUNCH_PARAMS function(@NativeType("CUfunction") int value) { nfunction(address(), value); return this; }
    ...
    public static int nfunction(long struct) { return UNSAFE.getInt(null, struct + CUDA_LAUNCH_PARAMS.FUNCTION); }
    ...
    /** Unsafe version of {@link #function(int) function}. */
    public static void nfunction(long struct, int value) { UNSAFE.putInt(null, struct + CUDA_LAUNCH_PARAMS.FUNCTION, value); }
    ...
    public static class Buffer extends StructBuffer<CUDA_LAUNCH_PARAMS, Buffer> implements NativeResource {
        ...
        /** Returns the value of the {@code function} field. */
        @NativeType("CUfunction")
        public int function() { return CUDA_LAUNCH_PARAMS.nfunction(address()); }
        /** Returns the value of the {@code gridDimX} field. */
        @NativeType("unsigned int")
        ...
        /** Sets the specified value to the {@code function} field. */
        public CUDA_LAUNCH_PARAMS.Buffer function(@NativeType("CUfunction") int value) { CUDA_LAUNCH_PARAMS.nfunction(address(), value); return this; }
        /** Sets the specified value to the {@code gridDimX} field. */
